...
var _jquery321Min = __webpack_require__(24);
...
window.$ = window.jQuery = _jquery321Min2.default;
// let socket = io(config.domain);

// import io from "socket.io-client";
$(document).ready(function () {
    // requestAnimationFrame(mainLoop);
    new _Game2.default("screen");
});
...
var Game = function () {
    function Game(canvasId) {
        ...
        this.bodies = [new _Player2.default(this, this.gameSize)];

        this.gameLoop = function () {
            _this.update();
            _this.draw(_this.screen, _this.gameSize);
    ...
    _createClass(Game, [{
        key: "darwRect",
        value: function darwRect(screen, body) {
